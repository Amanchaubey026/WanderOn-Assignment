                ...
                <Flex h={16} alignItems={'center'} justifyContent={'space-between'}>
                    ...
                    <HStack spacing={8} alignItems={'center'}>
                        ...
                        <HStack
                            ...
                            {Links.map((link) => (
                                <NavLink key={link.name} to={link.path} onClick={link.name === 'Product' ? handleProductsClick : null}>{link.name}</NavLink>
                            ))}
                        </HStack>
                    </HStack>
                    <Flex alignItems={'center'}>
                        {isLoggedIn && (
                            <Button onClick={handleLogout} variant="link" mr={4}>Logout</Button>
                        )}
                        <Menu>
                            <MenuButton
                                as={Button}
